...
Ans) The most frequent words in long description are web, browser, serach, private, engine, etc. Word cloud of words is shown in figure-3.1
<p align="center">
...
Ans) The most frequent words in short description are private, browser, amp, etc.
...
Ans) From the word clouds for short and long descriptions, we can observe that they have some words in common like browser, private, ad blocker, etc.
